...
누군가는 바로 움직여야 한다는 사실만이 분명하다.`,
    ...
    scores: {
      A: { lena: 5, rahel: 4, dowon: 3, runa: 5 },
      B: { lena: 3, rahel: 3, dowon: 5, runa: 2 },
      C: { lena: 4, rahel: 5, dowon: 4, runa: 3 },
      D: { lena: 1, rahel: 2, dowon: 2, runa: 5 }
    }
  },
  {
    id: 2,
...
선택 하나에 오늘 밤의 흐름이 달라질 것 같다.`,
    ...
    scores: {
      A: { lena: 3, rahel: 5, dowon: 1, runa: 4 },
      B: { lena: 4, rahel: 3, dowon: 5, runa: 3 },
      C: { lena: 5, rahel: 4, dowon: 3, runa: 5 },
      D: { lena: 1, rahel: 1, dowon: 2, runa: 2 }
    }
  },
  {
    id: 3,
...
이 집을 어떻게 다녀갈지, 짧은 판단이 필요하다.`,
    ...
    scores: {
      A: { lena: 3, rahel: 5, dowon: 2, runa: 4 },
      B: { lena: 4, rahel: 3, dowon: 4, runa: 5 },
      C: { lena: 5, rahel: 4, dowon: 5, runa: 4 },
      D: { lena: 4, rahel: 2, dowon: 3, runa: 3 }
    }
  },
  {
    id: 4,
...
이 선물은 어떻게 해야 할까?`,
    ...
    scores: {
      A: { lena: 2, rahel: 5, dowon: 3, runa: 4 },
      B: { lena: 5, rahel: 3, dowon: 5, runa: 3 },
      C: { lena: 4, rahel: 4, dowon: 4, runa: 5 },
      D: { lena: 3, rahel: 2, dowon: 2, runa: 2 }
    }
  },
  {
    id: 5,
...
마음이 급해지지만, 선택은 해야 한다.`,
    ...
    scores: {
      ...
      C: { lena: 4, rahel: 5, dowon: 4, runa: 4 },
      D: { lena: 2, rahel: 1, dowon: 2, runa: 3 }
    }
  },
  {
    id: 6,
...
이 집을 대하는 방식이 떠오른다.`,
    ...
    scores: {
      A: { lena: 2, rahel: 1, dowon: 2, runa: 5 },
      B: { lena: 5, rahel: 4, dowon: 4, runa: 4 },
      C: { lena: 4, rahel: 5, dowon: 5, runa: 3 },
      D: { lena: 3, rahel: 4, dowon: 3, runa: 2 }
    }
  },
  {
    id: 7,
...
이 상태로 밤을 계속 버틸 수 있을까?`,
    ...
    scores: {
      A: { lena: 5, rahel: 4, dowon: 5, runa: 4 },
      B: { lena: 3, rahel: 5, dowon: 3, runa: 3 },
      C: { lena: 4, rahel: 3, dowon: 4, runa: 5 },
      D: { lena: 2, rahel: 2, dowon: 2, runa: 2 }
    }
  },
  {
    id: 8,
...
손에 쥔 편지가 쉽게 접히지 않는다.`,
    ...
    scores: {
      A: { lena: 5, rahel: 4, dowon: 4, runa: 5 },
      B: { lena: 3, rahel: 5, dowon: 5, runa: 4 },
      C: { lena: 4, rahel: 3, dowon: 3, runa: 3 },
      D: { lena: 2, rahel: 2, dowon: 2, runa: 2 }
    }
  },
  {
...
이 선택이 오늘 밤의 마지막 방향을 정한다.`,
    ...
    scores: {
      A: { lena: 5, rahel: 3, dowon: 4, runa: 2 },
      B: { lena: 4, rahel: 5, dowon: 5, runa: 4 },
      C: { lena: 4, rahel: 4, dowon: 4, runa: 5 },
      D: { lena: 2, rahel: 2, dowon: 1, runa: 3 }
    }
  },
  {
    id: 10,
...
이 밤을 지나온 너 자신의 마음을 마주한다.`,
    ...
    scores: {
      A: { lena: 5, rahel: 5, dowon: 5, runa: 4 },
      B: { lena: 3, rahel: 4, dowon: 3, runa: 5 },
      C: { lena: 4, rahel: 3, dowon: 4, runa: 3 },
      D: { lena: 2, rahel: 2, dowon: 2, runa: 2 }
    }
  }
]
